...
| **服务端镜像拉取** | `docker pull ccr.ccs.tencentyun.com/hhxs2025/fn-appstores-server:2.4.0` |
...
```
v2.1.1 ──► v2.2.0-beta ──► v2.2.0 ──► v2.2.1 ──► v2.2.2 ──► v2.2.3 ──► v2.3.0 ──► v2.3.1 ──► v2.3.2
```
...
| **v2.3.1** | 修复内含向导的应用安装向导环境变量字段命名不规范而导致的安装失败的问题及其他 bug |
